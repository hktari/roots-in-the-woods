...
export class Convert {
    public static toAlbums(json: string): Albums {
        return cast(JSON.parse(json), r("Albums"));
    }

    public static albumsToJson(value: Albums): string {
        return JSON.stringify(uncast(value, r("Albums")), null, 2);
    }
}
...
const typeMap: any = {
    "Albums": o([
        { json: "data", js: "data", typ: a(r("AlbumsDatum")) },
        { json: "paging", js: "paging", typ: r("AlbumsPaging") },
    ], false),
    "AlbumsDatum": o([
    ...
    "Photos": o([
        { json: "data", js: "data", typ: a(r("PhotosDatum")) },
        { json: "paging", js: "paging", typ: r("PhotosPaging") },
    ], false),
    "PhotosDatum": o([
        { json: "webp_images", js: "webp_images", typ: a(r("WebpImage")) },
        { json: "id", js: "id", typ: "" },
    ], false),
    "WebpImage": o([
